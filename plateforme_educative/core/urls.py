...
from .views import (
    ...
    process_demande_view,
    student_create_demande_view,
...
urlpatterns = [
    ...
    path('dashboard/admin/demandes/<int:demande_id>/process/', process_demande_view, name='dashboard_admin_process_demande'),
    ...
    path('dashboard/student/demandes/creer/', student_create_demande_view, name='dashboard_student_create_demande'),
