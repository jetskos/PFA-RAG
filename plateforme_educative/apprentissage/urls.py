...
urlpatterns = [
    ...
    path('formateur/cours/<uuid:pk>/toggle/', views.toggle_cours_actif, name='toggle_cours_actif'),
    ...
    path('formateur/chapitre/<uuid:chapitre_id>/toggle/', views.toggle_chapitre_actif, name='toggle_chapitre_actif'),
